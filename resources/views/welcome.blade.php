                            ...
                            @if (!is_null($content))
                                ...
                                <div
                                    ...
                                    <a class="btn btn-primary btn-lg px-5 py-3 fs-6 fw-bolder"
                                        href="profile">{{ $content->button_left }}</a>
                        ...
                        @if (!is_null($content))
                            <div class="text-center my-5">
                                ...
                                <div class="d-flex justify-content-center fs-2 gap-4">
                                    <a class="text-gradient" href="https://www.facebook.com/profile.php?id=100055599300243&mibextid=JRoKGi"><i class="bi bi-facebook"></i></a>
                                    <a class="text-gradient" href="https://www.instagram.com/rrchristawani?igsh=MWxkOXBhcmJ1cXN0eA=="><i class="bi bi-instagram"></i></a>
    ...
    <footer class="bg-white py-4 mt-auto">
        <div class="container px-5">
            <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                <div class="col-auto">
                    <div class="small m-0">
                    <span>Copyright &copy; <a href="https://www.instagram.com/rrchristawani?igsh=MWxkOXBhcmJ1cXN0eA==" target="_blank">rrchristawani</a> {{ now()->year }}</span>
                    </div>
                </div>
                <div class="col-auto">
